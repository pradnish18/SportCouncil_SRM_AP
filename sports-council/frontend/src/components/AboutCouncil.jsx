      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-block px-4 py-1.5 mb-6 text-[10px] font-bold tracking-[0.3em] uppercase border rounded-xl border-brand-srm/20 bg-brand-srm/10 text-brand-srm">
              Our Mission
            </div>
